...
> Design notes for **game-asset-moderation-gateway** — a runnable typescript example that A typed game backend that routes player-created assets through an OpenAI-compatible moderation queue.
...
- **Feature code** — the actual task: player-asset-moderation.
